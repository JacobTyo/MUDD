This is forked and modified from https://github.com/KaiyangZhou/deep-person-reid

To run with the performance photo data, use any of the configs in the `train/` directory.
To get the data:
1. Download the dataset https://drive.google.com/file/d/1GAB-ocw5dhFCRmW_hsPw9AJrCZbdg8iq/view?usp=drive_link
2. Extract the dataset to `reid-data/` (The path will look like `reid-data/performance/{bounding_box_test, bounding_box_train, query}`)

The raw dataset can be downloaded here: https://drive.google.com/file/d/1lRjcca2LcQ-6xCiO76ryS7C9NcREiXAV/view?usp=drive_link
